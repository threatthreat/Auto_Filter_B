...
API_ID = int(environ.get('API_ID', '16708960')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', 'dda7630be99593256cb7c520eae0ce6d')  # API Hash from my.telegram.org
...
PICS = (environ.get('PICS', 'https://files.catbox.moe/639tm6.jpg https://files.catbox.moe/5n3zlm.jpg https://files.catbox.moe/n7ybji.jpg https://files.catbox.moe/q1hffm.jpg')).split()  # Sample pic
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5482962500').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002355897941').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002374553598'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002659103545'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002671798198'))  # Premium logs channel id
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002355897941').split()] #(make sure bot is admin)
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002587184746')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002512625570')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/')  # Support group link (make sure bot is admin)

# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1002665145530")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-1002275381683")# Channels for force sub (make sure bot is admin)
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Safaribotts') # Collection name (default: dreamcinezone_files)
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002522586530'))  # Notification of sent to your channel
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002647011471')) #Verification Channel Id 
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/Bombardiro_Crocodiloa")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/Bombardiro_Crocodiloa")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/Bombardiro_Crocodiloa")   # Third tutorial link for verification

# Verification (Must Fill All Veriables. Else You Got Error
SHORTENER_API = environ.get("SHORTENER_API", "54528f37e15baa266842ef63286e58ca152896cb") # Shortener API key
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "softurl.in") # Shortener website

SHORTENER_API2 = environ.get("SHORTENER_API2", "54528f37e15baa266842ef63286e58ca152896cb")  # Shortener API key for second website
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "softurl.in") # Shortener website for second website

SHORTENER_API3 = environ.get("SHORTENER_API3", "8b926755d7f87b3eabffb2cbca3a8df12cb19d6c")  
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Moviesandseries36') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/TylerDurden_T4') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/viberox') # Update channel link for the bot
